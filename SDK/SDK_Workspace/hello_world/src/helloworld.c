...
{
    init_platform();
    unsigned char string_s[] = "STANKO JE GEJ!\n";
    unsigned char c1 = 'X';
    unsigned char c2 = 'G';
    int r = 5;
    ...
    set_cursor(350);
    print_string(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, string_s, 14);
    set_cursor(450);
    print_char(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, c1);
    set_cursor(460);
    print_char(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, c2);

    set_background_color(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, 0xff6699);
    set_foreground_color(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, 0x0066ff);

    draw_circle(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, r);
